            ...
            <div className="faq container">
                ...
                <div className="answers">
                    <div className="form-response">
                        <h2 className = "h2-help">Upvote a feature that you like</h2>
                        <img src = {upvote}/>
                    ...
                    <div className="form-response">
                        <h2 className = "h2-help">See if a certain feature already exists</h2>
                        <img src = {search}/>
                    ...
                    <div className="form-response">
                        <h2 className = "h2-help">Propose a new feature</h2>
                        <img src = {propose}/>
                    ...
                    <div className="form-response">
                        <h2 className = "h2-help">Leave a comment under a feature</h2>
                        <img src = {comment}/>
